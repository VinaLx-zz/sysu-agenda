...
class AgendaService {
  public:
     ...
     */
    int deleteUser(const std::string &userName, const std::string &password);
     ...
     */
    std::list<Meeting> meetingQuery(
        const std::string &userName, const std::string &title) const;
    /**
     * search a meeting by username, time interval (user as sponsor or
     * participator)
     * @param uesrName the user's userName
     ...
     * @return a meeting list result
     */
    std::list<Meeting> listAllSponsorMeetings(
     ...
     * @return the number of deleted meeting
     */
    int deleteMeeting(const std::string &userName, const std::string &title);
     ...
     * @return the number of deleted meeting
     */
    int deleteAllMeetings(const std::string &userName);
